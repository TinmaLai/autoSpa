    ...
    <div class="product-detail-container">
      ...
      <div class="product-content">
        ...
        <div class="product-description">
          <div class="product-detail-price">
            Giá: <span class="origin-price"><input class="styled-input" :value="product.product_original_price">
              VNĐ</span>
      ...
      <div class="related-product">
        ...
        <div class="related-product-list">
          <div v-for="(item, index) in relatedItems" :key="index" @click="showDetail(item.product_id)" class="item"
            @mouseover="idHover = item.product_id" @mouseleave="idHover = null">
            <div class="overlay"
              :class="{ 'opacity-1': idHover === item.product_id, 'opacity-0': idHover !== item.product_id }"></div>
            <div class="img-item">
      ...
      .related-product-list {
        ...
        .item {
          ...
          .overlay {
            ...
            height: 100%;
            box-shadow:
              inset 0 0 15px rgba(255, 80, 0, 1),
              /* Lớp cam đậm */
              inset 0 0 30px rgba(255, 120, 0, 0.9),
              /* Lớp cam sáng hơn */
              inset 0 0 50px rgba(255, 180, 0, 0.7),
              /* Lớp vàng mạnh hơn */
              inset 0 0 80px rgba(255, 255, 0, 0.5);
            /* Lớp vàng lan tỏa */
            pointer-events: none;
            /* Cho phép nhấp vào ảnh mà không bị lớp phủ chặn */
          }
